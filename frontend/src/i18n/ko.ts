...
export const ko: Record<I18nKey, string> = {
  ...
  // 첨부파일 — 문서 페이지와 이슈(태스크/버그) 상세가 함께 사용합니다.
  'attachments.title': '첨부파일',
  'attachments.add': '파일 첨부',
  'attachments.remove': '파일 삭제',
  'attachments.hint': 'PDF, Word, Excel 파일을 여기에 끌어다 놓아도 됩니다',
  ...
  'uploads.uploading': '업로드 중',
  'uploads.queued': '대기 중…',
  'uploads.finishing': '마무리 중…',
  'uploads.failed': '실패',
  'uploads.dismiss': '닫기',
